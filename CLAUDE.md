...
TracerPayloadInspector is a quick-and-dirty mock trace agent used to inspect traces generated by Datadog tracers. It listens for HTTP requests containing MessagePack-encoded trace payloads and can display statistics and save payloads for inspection.
