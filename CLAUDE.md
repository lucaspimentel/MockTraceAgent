...
TracerPayloadInspector is a diagnostic tool for inspecting and debugging Datadog tracer payloads. It listens for HTTP requests containing MessagePack-encoded trace payloads and provides visualization, statistics, and payload saving capabilities.
...
- **Datadog.Apm.TracerPayloadInspector.Core** - Shared library containing core trace processing logic
- **Datadog.Apm.TracerPayloadInspector.NuGet** - NuGet package for embedding the inspector in applications
...
```
Datadog.Apm.TracerPayloadInspector/
├── Datadog.Apm.TracerPayloadInspector.Cli/
│   ├── Datadog.Apm.TracerPayloadInspector.Cli.csproj   # CLI application project
...
### Datadog.Apm.TracerPayloadInspector.Core (Shared Library)

Core components shared between CLI, Web, and NuGet projects:
...
### Datadog.Apm.TracerPayloadInspector.Cli (CLI Application)
...
### Datadog.Apm.TracerPayloadInspector.Web (Web Application)
...
### Datadog.Apm.TracerPayloadInspector.NuGet (NuGet Package)

Library for embedding the payload inspector in .NET applications:

1. **TracerPayloadInspectorService.cs** - IHostedService implementation
...
The inspector expects MessagePack-encoded payloads at `/v0.4/traces` in the format:
